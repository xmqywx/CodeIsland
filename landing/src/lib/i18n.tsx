...
const translations = {
  ...
  "pricing.codelight.price": { zh: "$13.99 买断", en: "$13.99 lifetime" },
  ...
  "pricing.codelight.beta": { zh: "iPhone", en: "iPhone" },
  "pricing.codelight.cta": { zh: "App Store 下载", en: "Download on App Store" },
  "pricing.codelight.future": { zh: "3 天免费试用 · 到期后 $13.99 买断 (3 台设备并发) · 或参与发内容换 30 天兑换码活动", en: "3-day free trial · $13.99 lifetime after (3-device concurrent) · Or earn 30-day codes by sharing content" },
  ...
  "faq.a3": { zh: "MioIsland (Mac) 永久免费开源 (CC BY-NC 4.0)。Code Light (iPhone) 走轻付费模式：①  App Store 下载后首次连接自动开启 3 天全功能试用 (不需要信用卡)；② 试用到期后 $13.99 一次买断，同一 Apple ID 最多 3 台设备并发在线；③ 想免费长期用：参与「发一条, 免费用」活动——在任意公开平台发一条关于 MioIsland/Code Light 的内容，截图私信开发者，审核通过即得 30 天免费兑换码，持续发一直免费。", en: "MioIsland (Mac) is free and open source forever (CC BY-NC 4.0). Code Light (iPhone) uses a light paid model: (1) 3-day full-feature trial starts automatically on first connect after App Store install (no credit card); (2) After trial, $13.99 one-time buy-out — same Apple ID, up to 3 devices concurrently; (3) For continued free use: join the 'Post & Play Free' program — share a clip about MioIsland/Code Light on any public platform, DM us the screenshot, get a 30-day redeem code per approved post." },
