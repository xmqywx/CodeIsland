...
## 📱 **[Code Light](https://github.com/xmqywx/CodeLight)** —— 你的 iPhone 伴侣 🐱✨
...
CodeIsland 的 **Code Light Sync 模块**把刘海应用变成 Mac、云端、iPhone 之间的双向桥梁：
...
> CodeIsland 的 Sync 模块已包含在 v1.9.0+ 中。⭐ **[给 CodeIsland 加 Star](https://github.com/xmqywx/CodeIsland)** + ⭐ **[给 Code Light 加 Star](https://github.com/xmqywx/CodeLight)** 以获取更新通知。
